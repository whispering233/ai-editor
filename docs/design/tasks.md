...
## 项目状态（2026-09-05，v0.0.25 已发布）

v0.0.1-v0.0.25 发布链路全绿；v0.0.25 = 文档体系重组（`doc/`→`docs/`、api 模块拆分、冗余清理、architecture 分包去代码文件级、layout 去样式化）。**无待做项**；迭代演进路线见 `milestone.md`；运行/构建/发布手册见 `build.md`；里程碑版本史见根 `CHANGELOG.md`。
