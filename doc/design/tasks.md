...
- **待做**：E4-E6 发布阻断项（E1-E3 导出/导入已完成；E4 未来版本拒绝重建 / E5 增量迁移机制 / E6 publishConfig + publish 演练，规格见文末「发布前阻断项」段）；backlog 事项一律不做。
- **测试**：全仓 1270 个（shared 87 / db 187 / server 238 / client 380 / tools 225 / llm 59 / agent 94）。
