...
> **本文档是什么**：设计历史**全量档案**——收录决策 1-48 与「决策 27 修订」的完整原文（含已过时、已被修订/取代的内容与演变脉络），与原版一字未改。
>
> **当前版本**：精简版见 [`decisions.md`](./decisions.md)——只保留核心架构理念（每个决策 3-5 行），更易通读。
>
> **决策编号是稳定锚点**：全仓库文档以「决策 N」引用，编号不因精简而重排；查任一决策的完整设计史，请回到本文档。
