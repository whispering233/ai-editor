...
//
// 同步范围：packages/{shared,db,tools,agent,server,client,desktop} + 根 package.json。
// client 与 desktop 虽 private 不发布，但保持仓库内版本一致（发布流程发 5 包 + 同一 tag 的桌面安装包）。
...
const PACKAGES = ["shared", "db", "tools", "agent", "server", "client", "desktop"];
